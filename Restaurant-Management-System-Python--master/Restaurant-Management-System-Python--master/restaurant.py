...
f1 = Frame(root, width=850, height=700, relief=SUNKEN)
f1.pack(side=LEFT, padx=(0, 20))  # Adding padding on the right side

f2 = Frame(root, width=450, height=700, relief=SUNKEN)
f2.pack(side=LEFT, padx=(150, 0))  # Adding padding on the left side

#------------------TIME--------------
localtime=time.asctime(time.localtime(time.time()))
#-----------------INFO TOP------------
lblinfo = Label(Tops, font=( 'aria' ,30, 'bold' ),text="Restaurant Ordering System",fg="steel blue",bd=10,anchor='w')
...
status = Label(f2,font=('aria', 15, 'bold'),width = 16, text="-By AMT",bd=2,relief=SUNKEN)
